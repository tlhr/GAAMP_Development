...
//		pMol_ESP->Restrain_All_Torsions(0);
		pMol_ESP->FullGeometryOptimization_LBFGS_drude(1);
...
double CFitting::Cal_Chi_SQ_Int_Energy_Mol_Water(int OutputFlag)
{
	...
	if(nFit_Acceptor !=0)	{
		...
		OptWater.Para_List[0] = 2.5;	OptWater.Para_List[1] = 0.0;
