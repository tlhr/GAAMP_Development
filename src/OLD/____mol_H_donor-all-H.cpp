...
{
	int i, j, Phi=0, DonorSelect, Count;
...
//				sprintf(szWorkDir, "%s/dat-donor-%d-%d", szCurDir, Idx_Donor+1, ActiveAtom+1);
				...
				fprintf(fFile_Run_Log, "mol_H_donor.cpp> %2d H %2d donor: %2d atom %3s QM, E_min = %7.4lf r_min = %7.4lf\n", 
					Idx_Donor+1, ActiveHAtom+1, i+1, szElemName[i], E_Min_QM, r_Emin_QM);
				...
				fprintf(fOut, "#Energy    %3d donor %2d atom %3s QM ", Idx_Donor+1, ActiveHAtom+1, szElemName[ActiveAtom]);
				fprintf(fOut, "%12.6lf %9.4lf ", E_Min_QM, r_Emin_QM);
				fprintf(fOut, "\n");
				
				fprintf(fOut, "Donor %5d %12.6lf %9.4lf \n", ActiveHAtom+1, E_Min_QM, r_Emin_QM);
