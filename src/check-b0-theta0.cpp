...
void Update_Rtf_File_with_New_Atom_Type(void)
{
	...
	while(1)	{
		...
		if(ReadLine == NULL)	{
			...
			if(strncmp(szRtfTxt[nLine], "MASS 101   HT_W", 15) == 0)	{	// the entry for TIP3
...
void Add_New_Atom_Type_Prm_File(void)
{
	...
	while(1)	{
		...
		else if(strncmp(szPrmTxt[nLine],"HT_W   HT_W ", 12)==0)	{
		}
		else if(strncmp(szPrmTxt[nLine],"OT_W   HT_W ", 12)==0)	{
		}
		else if(strncmp(szPrmTxt[nLine],"HT_W   OT_W   HT_W", 18)==0)	{
		}
		else if(strncmp(szPrmTxt[nLine],"HT_W     0.000000", 17)==0)	{
		}
		else if(strncmp(szPrmTxt[nLine],"OT_W     0.000000", 17)==0)	{
		}
		else	{
			To_Output[nLine] = 1;
			nLine++;
